...
if __name__ == '__main__':
    ...
    parser.add_argument("--start_type", type=none_or_str, default=None, help="Start paths with chosen type")
    parser.add_argument("--end_type", type=none_or_str, default=None, help="End paths with chosen type")
    ...
    SAVE_DIR = os.path.join(ROOT_DATA_DIR, 'sampledLP')
    # Dataset directories.
