...
from helper.models.rl.CAFE.cafe_utils import DATA_DIR

from helper.knowledge_graphs.kg_base import KnowledgeGraph
from helper.knowledge_graphs.kg_macros import USER, REV_PREFIX
        ...
        with gzip.open(triple_file, "rb") as f:
            ...
            for line in f:
                ...
                if rel not in self.relation_info:
                    ...
                    assert self.relation_info[rel] == (head_ent, tail_ent) #official code
                    #pass
                # Add edge.
