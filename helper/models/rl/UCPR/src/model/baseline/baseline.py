...
from helper.models.rl.UCPR.src.model.lstm_base.model_kg import KG_KGE#, RW_KGE
from helper.models.rl.UCPR.src.model.lstm_base.model_kg_pre import KG_KGE_pretrained#, RW_KGE_pretrained
from helper.models.rl.UCPR.src.model.lstm_base.backbone_lstm import KGState_LSTM
from helper.models.rl.UCPR.utils import PADDING
from helper.datasets.datasets_utils import load_kg,load_dataset
from helper.knowledge_graphs.kg_macros import SELF_LOOP
...
class ActorCritic(nn.Module):
    ...
    def generate_st_emb(self, batch_path, up_date_hop = None):
        ...
        state_output = torch.cat([self._get_state_update(index, path).unsqueeze(0)
    ...
    def _get_state_update(self, index, path):
        ...
        if len(path) == 1:
            ...
            st_emb = torch.cat([user_embed, curr_node_embed, last_node_embed, last_relation_embed], -1)
