...
if __name__ == '__main__':
    ...
    parser.add_argument("--start_type", type=none_or_str,
                        default=None, help="Start paths with chosen type")
    parser.add_argument("--end_type", type=none_or_str,
                        default=None, help="End paths with chosen type")
    ...
    kg.random_walk_sampler(max_hop=MAX_HOP, logdir=LOGDIR, ignore_rels=set(), max_paths=N_PATHS,                    
