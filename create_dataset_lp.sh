...
pip install . && python3 pathlm/sampling/main_LP.py --root_dir $ROOT_DIR --data_dir $DATA_DIR --dataset $DATASET --max_n_paths $NPATHS --max_hop $HOPS --nproc $NPROC --start_type product --end_type entity --itemset_type all --task lp
