...
class UKGCLM(GPT2LMHeadModel):
    ...
    def __init__(self, config):
        ...
        self.num_kg_types = len(UKGCLM.kg_categories)
    ...
    def __init_type_embeddings(self, batch_size, num_hops):
        ...
        for i in range(n_tokens):
            if i == 0 or i == n_tokens - 1:
                type_ids[:, i] = UKGCLM.SPECIAL_ID
            elif i % 2 == 1:
                type_ids[:, i] = UKGCLM.ENTITY_ID
            elif i % 2 == 0:
                type_ids[:, i] = UKGCLM.RELATION_ID
    ...
    def __get_type_embeds(self, n_rows, n_cols):
        ...
        row = torch.hstack([row, torch.ones((1, 1)) * UKGCLM.SPECIAL_ID])
