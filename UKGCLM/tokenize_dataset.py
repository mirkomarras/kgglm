...
if __name__ == "__main__":
    ...
    parser.add_argument("--task", type=str, default="pretrain", help="{pretrain, finetuneRec, finetuneLP"
                                                                     "end-to-end}")
    parser.add_argument("--train_tokenizer", type=bool, default=False, help="Weather to train the tokenizer or not")
    ...
    if args.train_tokenizer:
        ...
        if os.path.exists(tokenizer_file):
            ...
            raise FileNotFoundError(f"Tokenizer file {tokenizer_file} not found. Please train the tokenizer first.")
