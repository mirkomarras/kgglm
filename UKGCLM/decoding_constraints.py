...
class ConstrainedLogitsProcessorLP(LogitsProcessor):
    def __init__(self, tokenized_kg, positive_token_map, total_length, tokenizer, num_return_sequences,
        ...
        self.special_tokens_ids = [self.tokenizer.encode(x, add_special_tokens=False)[0] for x in self.tokenizer.all_special_tokens_extended]
        ...
        if cur_len == self.total_length:
            ...
            for idx in range(scores.shape[0]):
                ...
                if cur_len % 2 == 1:
                    ...
                    key = k1, k2
                    candidate_tokens = self.positive_token_map[key] + self.special_tokens_ids
