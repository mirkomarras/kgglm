...
def parse_sampler_args():
    ...
    parser.add_argument(
        "--dataset", type=str, default="ml1m", help="One of {ml1m, lfm1m}"
    )
    parser.add_argument(
        "--root_dir",
        type=str,
    ...
    parser.add_argument(
        ...
        type=str,
        default="",
        help="Sub-directory with dataset name to use to store the datasets",
    )
    parser.add_argument(
        "--data_dirname",
        type=str,
    ...
    parser.add_argument(
        "--nproc", type=int, default=4, help="Number of processes to sample in parallel"
    )
    parser.add_argument(
        "--start_type",
        type=none_or_str,
    ...
    parser.add_argument(
        ...
        type=str,
        default="rec",
        help="Sample paths for Recommendation or for Knowledge Completion (Link prediction)",
    )
