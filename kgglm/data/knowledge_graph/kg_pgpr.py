...
from kgglm.data.knowledge_graph.kg_macros import MAIN_PRODUCT_INTERACTION, USER
from kgglm.data.knowledge_graph.kg_utils import (
...
class PGPRKnowledgeGraph(KnowledgeGraph):
    ...
    def _load_reviews(self, dataset):
        ...
        for rid, data in enumerate(dataset.review.data):
            ...
            # (2) Add edges.
            main_product, main_interaction = MAIN_PRODUCT_INTERACTION[
