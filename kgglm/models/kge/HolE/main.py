...
from kgglm.models.kge.HolE.hole import HolE
from kgglm.models.kge.HolE.parser_hole import parse_args
...
def initialize_model(kg_train,b_size,emb_dim,weight_decay,margin,lr,use_cuda):
    """Define Model"""
    model = HolE(emb_dim,kg_train.n_ent, kg_train.n_rel,margin)
...
if __name__ == '__main__':
    ...
    if args.task=='train':
        ...
        if not args.lp:
            ...
            build_kg_triplets(args.dataset)
            kg_train = load_kg_lp(args.dataset, 'train')
        model=HolE(args.embed_size,kg_train.n_ent, kg_train.n_rel,args.margin)
