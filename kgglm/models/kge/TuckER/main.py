...
from kgglm.models.traditional.log_helper import logging_config, create_log_id
from kgglm.datasets.datasets_utils import get_set
from kgglm.evaluation.eval_metrics import evaluate_rec_quality
from kgglm.models.kge.TuckER.parser_tucker import parse_args
from kgglm.data_mappers.mapper_kge import get_watched_relation_idx
from kgglm.models.kge.TuckER.tucker import TuckER
from torch.optim.lr_scheduler import ExponentialLR

"""Utils"""
from kgglm.models.kge.utils import get_test_uids, get_log_dir,load_kg,get_users_positives,remap_topks2datasetid, get_users_positives_lp, get_set_lp, get_set_entities,metrics_lp, build_kg_triplets
...
def train(args):
    ...
    for epoch in iterator:
        ...
        t1 = time()
        """Phase 1: CF training"""
        running_loss=train_epoch(model,sampler,optimizer,scheduler,dataloader,epoch,kg_train.n_ent,args)
