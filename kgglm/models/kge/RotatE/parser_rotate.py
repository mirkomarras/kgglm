...
from kgglm.models.kge.utils import get_weight_dir, get_weight_ckpt_dir,get_preprocessed_torchkge_path
...
def parse_args():
    ...
    parser.add_argument('--K', type=int, default=10,
                        help='Topk size')
    parser.add_argument('--save_interval', type=int, default=1, # DA IMPLEMENTARE
