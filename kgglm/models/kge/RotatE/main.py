...
from kgglm.models.kge.RotatE.rotate import BinaryCrossEntropyLoss, RotatE
from kgglm.models.kge.RotatE.parser_rotate import parse_args
...
def train(args):
    ...
    for epoch in iterator:
        t1 = time()
        """Phase 1: CF training"""
        running_loss=train_epoch(model,sampler,optimizer,criterion,dataloader,epoch,args=args)
