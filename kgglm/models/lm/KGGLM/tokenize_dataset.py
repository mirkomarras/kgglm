...
from kgglm.models.lm.path_dataset import PathDataset
...
if __name__ == "__main__":
    ...
    parser.add_argument("--task", type=str, default="pretrain", help="{pretrain, finetuneRec, finetuneLP"
                                                                     "end-to-end}")
    parser.add_argument("--train_tokenizer", type=bool, default=False,
    ...
    if args.train_tokenizer:
        ...
        tokenizer.post_processor = processors.TemplateProcessing(
            ...
            special_tokens=[("[BOS]", tokenizer.token_to_id(
                "[BOS]")), ("[EOS]", tokenizer.token_to_id("[EOS]"))]
        )
