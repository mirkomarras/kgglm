...
from kgglm.knowledge_graphs.kg_macros import INTERACTION, PRODUCT, USER
from kgglm.models.kge.utils import get_weight_ckpt_dir
from kgglm.utils import (check_dir, get_data_dir, get_dataset_info_dir,
                          get_model_dir)
...
class FormatEmbeddings(KARSDataset):
    ...
    def _integrity_checks(self):
        assert self.dataset_name in INTERACTION, "Insert one of ML1M or LFM1M in uppercase"
