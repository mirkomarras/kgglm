...
from kgglm.datasets.datasets_utils import load_dataset
from kgglm.knowledge_graphs.kg_macros import KG_RELATION, SELF_LOOP, USER
from kgglm.models.rl.UCPR.src.model.lstm_base.backbone_lstm import \
    KGState_LSTM
from kgglm.models.rl.UCPR.src.model.lstm_base.model_kg import KG_KGE
from kgglm.models.rl.UCPR.src.model.lstm_base.model_kg_pre import \
    KG_KGE_pretrained
from kgglm.models.rl.UCPR.src.model.lstm_base.model_lstm_mf_emb import \
    AC_lstm_mf_dummy
from kgglm.models.rl.UCPR.utils import PADDING, TMP_DIR
