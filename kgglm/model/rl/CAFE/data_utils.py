...
from kgglm.data.knowledge_graph.kg_utils import KG_RELATION, PRODUCT, USER
from kgglm.model.rl.CAFE.cafe_utils import load_kg, load_user_products
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--dataset", type=str, default="beauty", help="One of {ml1m | lfm1m}"
    )
