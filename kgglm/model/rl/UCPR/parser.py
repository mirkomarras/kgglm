...
def parse_args():
    ...
    parser.add_argument(
        "--dataset", type=str, default="lfm1m", help="One of {ml1m or lfm1m}"
    )
    parser.add_argument(
        "--name", type=str, default="train_agent_enti_emb", help="directory name."
    )
    ...
    parser.add_argument(
        "--max_acts", type=int, default=50, help="Max number of actions."
    )
    ...
    parser.add_argument(
        "--reasoning_step", type=int, default=3, help="weight factor for entropy loss"
    )
    ...
    parser.add_argument(
        "--embed_size", type=int, default=50, help="knowledge embedding size."
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--hidden", type=int, nargs="*", default=[64, 32], help="number of samples"
    )
    parser.add_argument(
        "--gradient_plot",
        type=str,
        default="gradient_plot/",
        help="number of negative samples.",
    )
    parser.add_argument(
        "--best_save_model_dir", type=str, default="", help="best_save_model_dir"
    )
    parser.add_argument(
        "--reward_hybrid", type=int, default=0, help="weight factor for entropy loss"
    )
    parser.add_argument(
        "--reward_rh", type=str, default="", help="number of negative samples."
    )
    ...
    parser.add_argument(
        "--state_rg", type=int, default=0, help="state_require_gradient"
    )
    parser.add_argument("--kg_emb_grad", type=int, default=0, help="if kg_emb_grad")
    parser.add_argument(
        "--save_pretrain_model", type=int, default=0, help="save_pretrain_model"
    )
    ...
    parser.add_argument(
        "--sam_type", type=str, default="alet", help="number of negative samples."
    )
    parser.add_argument(
    ...
    parser.add_argument("--no_run_eval", action="store_false", help="Run evaluation?")
    parser.add_argument("--no_save_paths", action="store_false", help="Save paths")
    ...
    parser.add_argument("--non_sampling", action="store_true", help="core number")
    parser.add_argument(
        "--gp_setting", type=str, default="6000_800_15_500_250", help="core number"
    )
    parser.add_argument("--kg_no_grad", action="store_true", help="core number")
