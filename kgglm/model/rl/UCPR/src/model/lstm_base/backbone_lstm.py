...
class KGState_LSTM(nn.Module):
    def __init__(self, args, history_len=1):
        ...
        self.policy_lstm = EncoderRNN_batch(
            args, args.embed_size * 2, args.embed_size * 2, args.device
        )
...
class KGState_LSTM_ERU(nn.Module):
    def __init__(self, args, history_len=1):
        ...
        self.policy_lstm = EncoderRNN_batch(
            args, args.embed_size * 3, args.embed_size * 2, args.device
        )
...
class KGState_LSTM_no_rela(nn.Module):
    def __init__(self, args, history_len=1):
        ...
        self.policy_lstm = EncoderRNN_batch(
            args, args.embed_size, args.embed_size, args.device
        )
