...
from kgglm.model.kge.ComplEx.complex import ComplEx
from kgglm.model.kge.ComplEx.parser_complex import parse_args
...
def train(args):
    ...
    for epoch in iterator:
        ...
        running_loss = train_epoch(
            model, sampler, optimizer, dataloader, epoch, args=args
        )
