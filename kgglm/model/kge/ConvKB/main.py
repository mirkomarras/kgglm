...
from kgglm.model.kge.ConvKB.convkb import ConvKB
from kgglm.model.kge.ConvKB.parser_convkb import parse_args
...
def initialize_model(
    kg_train, b_size, emb_dim, weight_decay, lr, use_cuda, filters, margin, device
):
    """Define Model"""
    model = ConvKB(
        kg_train.n_ent,
