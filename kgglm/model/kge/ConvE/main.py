...
from kgglm.model.kge.ConvE.conve import ConvE
from kgglm.model.kge.ConvE.parser_conve import parse_args
...
def train(args):
    ...
    if not args.lp:
        ...
        kg_train = get_set_lp(args.dataset, "train")
    model, optimizer, dataloader = initialize_model(
        kg_train,
        args.batch_size,
        args.embed_size,
        args.weight_decay,
    ...
    for epoch in iterator:
        ...
        running_loss = train_epoch(
            model, optimizer, dataloader, epoch, kg_train.n_ent, args
        )
