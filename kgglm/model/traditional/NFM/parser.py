...
from pathlm.utils import SEED, get_weight_ckpt_dir, get_weight_dir
...
def parse_nfm_args():
    ...
    parser.add_argument(
        "--embed_dim", type=int, default=64, help="User / entity Embedding size."
    )
    parser.add_argument(
        "--hidden_dim_list",
        nargs="?",
    ...
    parser.add_argument(
        "--train_batch_size", type=int, default=4096, help="Train batch size."
    )
    parser.add_argument(
        "--test_batch_size", type=int, default=50, help="Test batch size."
    )
    parser.add_argument(
        "--test_cores", type=int, default=12, help="Number of cores when evaluating."
    )
    ...
    parser.add_argument(
        "--print_every", type=int, default=50, help="Iter interval of printing loss."
    )
    parser.add_argument(
        "--evaluate_every",
        type=int,
    ...
    parser.add_argument(
        "--save_interval", type=int, default=20, help="After how many epochs save ckpt"
    )
    parser.add_argument(
        "--Ks", nargs="?", default="[10]", help="Calculate metric@K when evaluating."
    )
