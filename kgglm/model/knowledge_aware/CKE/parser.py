...
def parse_args():
    ...
    parser.add_argument(
        "--pretrained_weights", type=str, default=None, help="Path to the model weights"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--layer_size", nargs="?", default="[64]", help="Output sizes of every layer"
    )
    parser.add_argument(
        "--mess_dropout",
        nargs="?",
    ...
    parser.add_argument("--batch_size", type=int, default=256, help="CF batch size.")
    parser.add_argument(
