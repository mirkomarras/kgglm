...
from kgglm.evaluation.eval_metrics import evaluate_rec_quality_from_results
from kgglm.evaluation.eval_utils import get_result_dir, get_set

if __name__ == "__main__":
    parser = argparse.ArgumentParser()
    parser.add_argument(
        "--model", type=str, default="distilgpt2", help="which model to evaluate"
    )
    parser.add_argument(
        "--dataset", type=str, default="ml1m", help="which dataset evaluate"
    )
    parser.add_argument("--sample_size", default="250", type=str, help="")
